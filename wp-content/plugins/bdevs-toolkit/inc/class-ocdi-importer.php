...
class OCDI_Demo_Importer {
    ...
    public function import_files_config() {
		...
		$home_prevs = array(
			'businoz_home_1' => array(
				'title' => __( 'Home 1', 'bdevs-toolkit' ),
				'page'  => __( 'home', 'bdevs-toolkit' ),
				'screenshot' => plugins_url( 'assets/preview/home.jpg', dirname(__FILE__) ),
				'preview_link' => 'https://bdevs.net/wp/businoz/',
			),
            'businoz_home_2' => array(
                ...
                'preview_link' => 'https://bdevs.net/wp/businoz/home-02/',
            ),
            'businoz_home_3' => array(
                ...
                'preview_link' => 'https://bdevs.net/wp/businoz/home-03/',
            ),
            'businoz_home_4' => array(
                'title' => __( 'Home 4', 'bdevs-toolkit' ),
                'page'  => __( 'home-04', 'bdevs-toolkit' ),
                'screenshot' => plugins_url( 'assets/preview/home4.jpg', dirname(__FILE__) ),
                'preview_link' => 'https://bdevs.net/wp/businoz/home-04/',
            ),
		);
