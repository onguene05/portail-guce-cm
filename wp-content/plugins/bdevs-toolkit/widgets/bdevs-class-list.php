...
Class Latest_Services_List_Widget extends WP_Widget{
	...
	public function __construct(){
		parent::__construct('bdevs-services-cats', 'Businoz Classes List', array(
			'description'	=> 'Businoz Classes List'
		));
	}
     	...
     	<?php endif; ?>
            ...
            <ul class="class_catagory">
				...
				<li class="mb-20">
                  ...
                  <a href="<?php the_permalink(); ?>"><i class="fal fa-chevron-double-right"></i></a>
               </li>
				<?php 
