<?php
	 ...
	 * @extends 	WP_Widget
	 */
	add_action('widgets_init', 'businoz_contact_info_widget');
	function businoz_contact_info_widget() {
		register_widget('businoz_contact_info_widget');
	}
	...
	class Kingfact_Contact_Info_Widget  extends WP_Widget{
		...
		public function __construct(){
			parent::__construct('businoz_contact_info_widget',esc_html__('Businoz Contact Info', 'bdevs-toolkit'),array(
				'description' => esc_html__('Businoz Contact Info Widget', 'bdevs-toolkit'),
			));
		}
