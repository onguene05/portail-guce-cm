<?php
	 ...
	 * @extends 	WP_Widget
	 */
	add_action('widgets_init', 'Businoz_info_Widget');
	function Businoz_info_Widget() {
		register_widget('Businoz_info_Widget');
	}
	
	
	class Businoz_info_Widget  extends WP_Widget{
		
		public function __construct(){
			parent::__construct('Businoz_info_Widget',esc_html__('Businoz Info','bdevs-toolkit'),array(
				'description' => esc_html__('Businoz Info Widget','bdevs-toolkit'),
			));
		}
