...
Class Latest_posts_sidebar_Widget extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct( 'bdevs-latest-posts', 'Businoz Sidebar Posts Image', [
            'description' => 'Latest Post Widget by Businoz',
        ] );
    }
	     	...
	     	<div class="sidebar__widget-content">
		        ...
		        <div class="d-flex mb-20">
	                ...
	                <div class="rc-thumb mr-20">
	                    <a href="<?php the_permalink();?>"><div class="sidebar-posts-bg-thumb" style="background-image: url(<?php print esc_url( get_the_post_thumbnail_url( get_the_ID(), 'full' ) );?>);"></div></a>
	                </div>
	                <?php endif;?>
