...
Class Latest_Services_Cat_List_Widget extends WP_Widget{
	...
	public function __construct(){
		parent::__construct('bdevs-services-cats-list', 'Businoz Services Category List', array(
			'description'	=> 'Businoz Services List'
		));
	}
	...
	public function widget($args, $instance){
	    ...
	    <div class="bd-service-widget gray-bg mb-30">
	        <div class="bd-service-sidebar-category">
		        <ul>
					<?php 
		            ...
		            <li>
		            	<a href="<?php echo esc_url( get_category_link( $category->term_id)); ?>"><?php echo esc_html($category->name); ?> <i class="far fa-chevron-right"></i></a>
		            </li>
					<?php endforeach; ?>
			        	<?php endif; ?>
						<?php 
