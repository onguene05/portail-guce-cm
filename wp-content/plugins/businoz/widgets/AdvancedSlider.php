...
class AdvancedSlider extends \Generic\Elements\GenericWidget {
    ...
    public function get_title() {
        return __( 'Advanced Slider', 'bdevs-elementor' );
    }

    public function get_custom_help_url() {
        return 'http://elementor.bdevs.net//widgets/advanced-slider/';
    }
    ...
    protected function register_content_controls() {
        ...
        $repeater->add_control(
            'shape_switch',
            [
                'label' => __('Shape SWITCHER', 'bdevselementor'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => __('Show', 'bdevselementor'),
                'label_off' => __('Hide', 'bdevselementor'),
                'return_value' => 'yes',
                'default' => 'yes',
                'style_transfer' => true,
            ]
        ...
        $repeater->start_controls_tab(
            ...
            [
                ...
                'condition' => [
                    'field_condition' => ['style_3', 'style_5'],
                ],
            ]
        );
                 ...
                 <?php foreach ( $settings['slides'] as $key => $slide ) :
                    ...
                    <div class="bd-single-slider bd-single-slider-overlay bd-slider-height d-flex align-items-center swiper-slide" data-swiper-autoplay="5000">
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-12">
                                    <div class="bd-slider z-index text-center bdevs-el-content pt-95">
                                        <?php if ( !empty($slide['title']) ) : ?>
                                        <h1 class="bd-slider-title mb-20 bdevs-el-title" data-animation="fadeInUp" data-delay=".3s"><?php echo wp_kses_post( $slide['title'] ); ?></h1>
                                        <?php endif; ?>
