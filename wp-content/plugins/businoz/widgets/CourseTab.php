...
class CourseTab extends \Generic\Elements\GenericWidget
{
    ...
    {
        return __('Course Tab', 'bdevs-elementor');
    }


    public function get_custom_help_url()
    {
        return 'http://elementor.bdevs.net/bdevselementor/course-tab/';
    }
    ...
    {
        return ['posts', 'courses', 'course-tab', 'post', 'post-tab', 'tab', 'news'];
    }
    ...
    protected function render()
    {
        ...
        <section class="course-area p-relative pt-115 pb-90">
            <?php if ( !empty($settings['shape_switch']) ): ?>
            <div class="course-shape-1">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/shape/portfolio-shap-1.png" alt="shape">
            </div>
            <div class="course-shape-2">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/shape/portfolio-shap-2.png" alt="shape">
            </div>
            <div class="course-shape-3">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/shape/portfolio-shap-3.png" alt="shape">
            </div>
            <?php endif; ?>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 grid-item <?php echo $item_classes; ?>">
                      <div class="eduman-course-main-wrapper mb-30">
                        ...
                        <div class="eduman-course-thumb w-img">
                            <a href="<?php print get_the_permalink() ?>"><img src="<?php echo esc_url($feature_img); ?>"
                                  alt="course-img"></a>
                        </div>
                        <?php endif; ?>
