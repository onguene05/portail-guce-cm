...
class WpfdControllerIconsbuilder extends Controller
{
    ...
    public function upload()
    {
        ...
        $uploadedIconsPath = WP_CONTENT_DIR . DIRECTORY_SEPARATOR . wpfd_get_content_dir() . DIRECTORY_SEPARATOR . 'icons' . DIRECTORY_SEPARATOR;
    ...
    public function restoreicons()
    {
        ...
        foreach ($extensions as $ext) {
            ...
            if (false !== $icon) {
                ...
                $sourceIconPath = WpfdHelperFile::getUploadedIconPath($extensionRand, $set, false);
...
//        $result['params'] = $model->getParams($set);
    ...
    private function getAllowedExtensions()
    {
        ...
        if (!isset($config['allowedext']) || (isset($config['allowedext']) && empty($config['allowedext']))) {
    ...
    {
        $defaultIconsPath = WP_CONTENT_DIR . DIRECTORY_SEPARATOR . wpfd_get_content_dir() . DIRECTORY_SEPARATOR . 'icons' . DIRECTORY_SEPARATOR;
    ...
    public function saveSingleParams()
    {
        ...
        $path = WP_CONTENT_DIR . $ds . wpfd_get_content_dir() . $ds;
