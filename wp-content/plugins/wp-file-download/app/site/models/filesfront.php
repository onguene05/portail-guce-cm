                ...
                if (wpfd_can_download_files()) {
                    if (!empty($rewrite_rules)) {
                        if (strpos($perlink, 'index.php')) {
                            $linkdownload     = untrailingslashit($site_url) . $wpfd_lang . '/index.php/' . $seo_uri . '/' . $ob->catid;
                            $linkdownload     .= '/' . $ob->catname . '/' . $result->ID . '/' . $result->post_name;
                            $ob->linkdownload = $linkdownload;
                        } else {
                            $linkdownload     = untrailingslashit($site_url) . $wpfd_lang . '/' . $seo_uri . '/' . $ob->catid . '/' . $ob->catname;
