            ...
            <?php if ((int) $args['cat_filter'] === 1) : ?>
                <div class="categories-filtering" >
                    ...
                    <div class="ui-widget wpfd-listCate" style="display: none">
                        ...
                        <input title="" type="hidden" value="<?php echo esc_html($currentCatId); ?>" id="filter_catid" class="chzn-select" name="catid" data-cattype="" data-slug="" />
                                ...
                                <li class="cate-item" data-catid="">
                                    ...
                                    foreach ($categories as $key => $category) {
                                        ...
                                        if (isset($filters['catid']) && (int) $filters['catid'] === $category->term_id) {
                                            ...
                                            if (gettype($category->term_id) === 'string') {
                                                $cateType = apply_filters('wpfdAddonCategoryFrom', $category->wp_term_id);
                                            } else {
                                                $cateType = 'default';
                                            }
