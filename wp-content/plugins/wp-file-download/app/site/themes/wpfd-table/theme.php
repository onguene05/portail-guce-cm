...
class WpfdThemeTable extends WpfdTheme
{
    ...
    public static function showTitleHandlebars($config, $params)
    {
        ...
        $template = array(
            'html' => $selectFileInput . '<a class="wpfd_downloadlink" href="%link$s" title="%title$s" target="%target$s"><span class="extcol">%icon$s</span>%croptitle$s</a>',
            'args' => array(
                'link'      => '{{linkdownload}}',
                'title'     => '{{post_title}}',
                'icon'      => $html,
    ...
    public static function showTitle($file, $config, $params)
    {
        ...
        $template = array(
            'html' => $selectFileInput . '<a class="wpfd_downloadlink" href="%link$s" title="%title$s" target="%target$s">%icon$s</a>',
            'args' => array(
