<?php
    ...
    $author_info = get_the_author_meta( 'businoz_write_by');
    $facebook_url = get_the_author_meta( 'businoz_facebook' );
    $twitter_url = get_the_author_meta( 'businoz_twitter' );
    $linkedin_url = get_the_author_meta( 'businoz_linkedin' );
    $instagram_url = get_the_author_meta( 'businoz_instagram' );
    $businoz_url = get_the_author_meta( 'businoz_youtube' );
    $businoz_write_by = get_the_author_meta( 'businoz_write_by' );
